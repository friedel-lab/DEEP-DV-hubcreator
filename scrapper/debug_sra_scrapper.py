...
sra_study_data.to_csv(f"{args.output_dir}/sraStudyDataDebug.txt", sep = "\t", index=False, na_rep="NA")
sra_run_data.to_csv(f"{args.output_dir}/sraRunDataDebug.txt", sep = "\t", index=False, na_rep="NA")